...
class Application_Model_Mapper_Stores_ShippingAddressesMapper extends Custom_Model_Mapper_Abstract
{
	...
	public function getShippingAddressesForStore(Application_Model_Stores_Store $store, array $options = null) {
		return $this->findByColumn('storeID', $store->storeID, $options);
	}
