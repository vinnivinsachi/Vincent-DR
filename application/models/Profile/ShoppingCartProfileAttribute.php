<?php
	...
	class Profile_ShoppingCartProfileAttribute extends Profile
	{
		...
		{
			$filters = array('shopping_cart_profile_attribute_id' => (int)$profile_id);  //this is very important because with out this being correct, you would run into foreign key errors. 
