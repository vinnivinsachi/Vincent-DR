...
<div style="font-weight:bold; width:500px; float:left;">
                    ...
                    <div class='tooltip' style='background-color:white; border:none;'> 
		                        ...
		                        <span style="font-weight:bold; {if $product.product_order_status=='SHIPPED'}color:#069;{elseif $product.product_order_status=='RETURN_SHIPPED' || $product.product_absolute_latest_delivery_date|date_format<$smarty.now|date_format}color:#F30;{elseif $product.product_order_status=='order completed' || $product.product_order_status=='order return completed'}color:#0C0;{else} color:#F90;{/if} font-size:12px; ">{removeunderscore phrase=$product.order_status}</span> 
