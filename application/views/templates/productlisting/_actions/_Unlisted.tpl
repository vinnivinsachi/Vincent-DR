<a href="{geturl action='sendproductlive'}?id={$product.product_id}&product={$product.product_type}&tag={$product.product_tag}"><img src="/public/resources/css/images/list.png" alt="List" title="List" /></a>
