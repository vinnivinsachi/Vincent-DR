	...
	<div id="accordion" style="margin-top:20px;">
        ...
        <div>
           {include file='partials/shoppingcart/_basketInformation.tpl}
        	...
        	<a id="proceedToShippingInfoAnchor" style="float:right; margin-top:10px;"><img src="{$siteRoot}/public/resources/css/images/OLD/nextToShipping.gif" style="margin-right:-9px;"/></a>
        	</div>
       </div>
        ...
        <div>
               <div style="padding:10px; border-bottom:1px solid #069; width:98%; float:left;">
                    ...
                    <div class="shippingAddressBox" id="shippingAddress_{$Key}">
                        ...
                        <a id="makeShippingAddress_{$Key}" class='makeShippingAddressAnchor' href="{geturl controller='account' action='makedefaultshipping}?editAddress={$Key}"><img src="{$siteRoot}/public/resources/css/images/OLD/ShippingButton.gif" /></a><br />
                        {/if}
                    </div>
                    {/foreach}
                    </div>
                ...
                <div style="float:left; width:98%; padding:0px 10px 10px 10px;">
                	<a id="backToCartInfo" style="float:left;"><img src="{$siteRoot}/public/resources/css/images/OLD/backToCart.gif" style="margin-left:-13px;"/></a>
                	<a  id="nextToRewardPointAnchor" style="float:right;{if !$defaultShippingKey}
display:none;{/if}"><img src="{$siteRoot}/public/resources/css/images/OLD/nextToRewardPointsAndPromotions.gif"/></a>
                </div>
        </div>
        ...
        <div>
            <div id="orderRewardsDetails" style="width:100%; float:left;">
             ...
             <a id="backToShippingInfoAnchor" style="float:left;"><img src="{$siteRoot}/public/resources/css/images/OLD/backToShipping.gif" /></a>
              <a id="proceedToComfirmation" style="float:right;"><img src="{$siteRoot}/public/resources/css/images/OLD/continueToConfirmation.gif" style="margin-bottom:-1px;"/></a>
            </div>
        </div>
    </div>
</div>
