...
<tr>
    ...
    <td>
    <form action="{geturl controller='adminaccount' action='processwithdraw'}" method="post">
    	<input type="hidden" name="withdrawId" value="{$withdraw.user_account_balance_withdraw_tracking_id}"/>
        <input type="submit" value="Process withdraw request" />
    </form>	
