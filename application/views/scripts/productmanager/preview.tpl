	...
	<div class="prview-status">
		...
		{if $product->isLive()}
			<div class="status live">
				...
				<div>
					<input type="submit" value="Unpublish Product" name="unpublish" id="status-unpublish" />
					<input type="submit" value="Edit Product" name="edit" id="status-edit" />
					<input type="submit" value="Delete Product" name="delete" id="status-delete" />
				</div>
			</div>
		{else}
			<div class="status draft">
				...
				<div>
					<input type="submit" value="Publish Product" name="publish" id="status-publish" />
