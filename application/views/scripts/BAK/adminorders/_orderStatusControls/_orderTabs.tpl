...
<div id="orderTabs" style="width:99%;">
    	  <ul>
            ...
            <li><a href="{geturl controller='adminorders' action='getorderprofiletype'}?type=HELD_BY_BUYER_FOR_ARBITRATION">Held by buyer for arb  ({$orderProfiles->heldByBuyerForArbitrationOrders|@count})</a></li>
             <li><a href="{geturl controller='adminorders' action='getorderprofiletype'}?type=HELD_BY_BUYER_FOR_ARBITRATION_APPROVED">Held by buyer for arb APPROVED({$orderProfiles->heldByBuyerForArbitrationApprovedOrders|@count})</a></li>
             <li><a href="{geturl controller='adminorders' action='getorderprofiletype'}?type=HELD_BY_BUYER_FOR_ARBITRATION_DENIED">Held by buyer for arb DENIED({$orderProfiles->heldByBuyerForArbitrationDeniedOrders|@count})</a></li>
            <li><a href="{geturl controller='adminorders' action='getorderprofiletype'}?type=HELD_BY_SELLER_FOR_ARBITRATION">Held by seller for arb  ({$orderProfiles->heldBySellerForArbitrationOrders|@count})</a></li>
            <li><a href="{geturl controller='adminorders' action='getorderprofiletype'}?type=HELD_BY_SELLER_FOR_ARBITRATION_APPROVED">Held by seller for arb APPROVED  ({$orderProfiles->heldBySellerForArbitrationApprovedOrders|@count})</a></li>
            <li><a href="{geturl controller='adminorders' action='getorderprofiletype'}?type=HELD_BY_SELLER_FOR_ARBITRATION_DENIED">Held by seller for arb DENIED ({$orderProfiles->heldBySellerForArbitrationDeniedOrders|@count})</a></li>
