...
class FCKeditor
{
	...
	public function CreateHtml()
	{
		...
		if ( $this->IsCompatible() )
		{
			...
			$Html .= "<iframe id=\"{$this->InstanceName}___Frame\" src=\"{$Link}\" width=\"{$this->Width}\" height=\"500px\" frameborder=\"0\" scrolling=\"no\"></iframe>" ;
		}
		else
		{
			...
			$Html .= "<textarea name=\"{$this->InstanceName}\" rows=\"4\" cols=\"40\" style=\"width: {$WidthCSS}; height: 500px\">{$HtmlValue}</textarea>" ;
		}
