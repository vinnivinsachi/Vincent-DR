<?php /* Smarty version 2.6.19, created on 2010-08-31 23:04:06
         compiled from productdisplay/_productDetails/_inventoryDetails.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'productdisplay/_productDetails/_inventoryDetails.tpl', 10, false),array('modifier', 'date_format', 'productdisplay/_productDetails/_inventoryDetails.tpl', 95, false),array('function', 'geturl', 'productdisplay/_productDetails/_inventoryDetails.tpl', 75, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "productdisplay/_productDetailsAttribute/_".($this->_tpl_vars['orderAttribute']).".tpl", 'smarty_include_vars' => array('product' => $this->_tpl_vars['product'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
 	
	 <div class='quickOrderActions' style='float:left; width:100%;'>
	 <?php if (isset ( $this->_tpl_vars['product']['0']['product_inventory_id'] )): ?>
	 	<?php if ($this->_tpl_vars['product']['0']['purchase_type'] == 'Customizable'): ?>
	  <a class='largeAnchorButton fullOrderDetailsColorBox' style='float:left; padding-left:10px; padding-top:10px;' href="<?php echo smarty_function_geturl(array('controller' => 'productdisplay','action' => 'purchasedetails'), $this);?>
?number=<?php echo $this->_tpl_vars['product']['0']['product_id']; ?>
&product=products">Customize this</a>
	  <?php endif; ?>
     <form method='post' action="<?php echo smarty_function_geturl(array('controller' => 'shoppingcart','action' => 'additemtoshoppingcart'), $this);?>
?product=Inventory&id=<?php echo $this->_tpl_vars['product']['0']['product_inventory_id']; ?>
">
