<?php /* Smarty version 2.6.19, created on 2010-08-27 22:47:31
         compiled from productlisting/editbuynowproduct.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'geturl', 'productlisting/editbuynowproduct.tpl', 10, false),array('function', 'wysiwyg', 'productlisting/editbuynowproduct.tpl', 74, false),array('modifier', 'count', 'productlisting/editbuynowproduct.tpl', 176, false),)), $this); ?>
...
' class='inputShiftOne'/>
			...
			<div class="systemColorSelection" >
				...
				<select name='inventory[sys_color]' class='inputShiftOne'>
					...
					<option value='Gray' <?php if ($this->_tpl_vars['inventory']['basic']['sys_color'] == 'Gray'): ?>selected="selected"<?php endif; ?>>Gray</option>
			...
			<div class="systemInventoryConditions">
				...
				<select name='inventory[sys_conditions]' class='inputShiftOne'>
					<option value='New' <?php if ($this->_tpl_vars['inventory']['basic']['sys_conditions'] == 'New'): ?>selected="selected"<?php endif; ?>>New</option>
					<option value='Like new' <?php if ($this->_tpl_vars['inventory']['basic']['sys_conditions'] == 'Like new'): ?>selected="selected"<?php endif; ?>>Like new</option>
					<option value='Good' <?php if ($this->_tpl_vars['inventory']['basic']['sys_conditions'] == 'Good'): ?>selected="selected"<?php endif; ?>>Good</option>
				</select>
			</div>
...
unset($_smarty_tpl_vars);
 ?>
			...
			<option value='1' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '1'): ?>selected="selected"<?php endif; ?>>1</option>
			<option value='2' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '2'): ?>selected="selected"<?php endif; ?>>2</option>
			<option value='3' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '3'): ?>selected="selected"<?php endif; ?>>3</option>
			<option value='4' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '4'): ?>selected="selected"<?php endif; ?>>4</option>
			<option value='5' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '5'): ?>selected="selected"<?php endif; ?>>5</option>
			<option value='6' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '6'): ?>selected="selected"<?php endif; ?>>5</option>
			<option value='7' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '7'): ?>selected="selected"<?php endif; ?>>7</option>
			<option value='8' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '8'): ?>selected="selected"<?php endif; ?>>8</option>
			<option value='9' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '9'): ?>selected="selected"<?php endif; ?>>9</option>
			<option value='10' <?php if ($this->_tpl_vars['inventory']['basic']['sys_quantity'] == '10'): ?>selected="selected"<?php endif; ?>>10</option>
			</select>
			</div>
			</div>
		</div>
