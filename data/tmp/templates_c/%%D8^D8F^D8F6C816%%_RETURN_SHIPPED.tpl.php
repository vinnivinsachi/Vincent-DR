<?php /* Smarty version 2.6.19, created on 2010-10-01 23:58:37
         compiled from ordermanager/_soldOrders/_RETURN_SHIPPED.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'removeunderscore', 'ordermanager/_soldOrders/_RETURN_SHIPPED.tpl', 14, false),array('modifier', 'date_format', 'ordermanager/_soldOrders/_RETURN_SHIPPED.tpl', 29, false),)), $this); ?>
...
Waiting for delivery confirmation			                            </div>
 ...
 on <?php echo ((is_array($_tmp=$this->_tpl_vars['product']['product_shipping_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
...
<br />
				...
				<div class="trackingActions" style="width:50%; float:right;">
                        ...
                        <div class="trackingInfo" style="width:100%; float:left;">
                            <div class="trackingInfoDetails" style=" width:50%; float:left;">
                            Return Tracking: <?php echo $this->_tpl_vars['product']['product_return_tracking']; ?>
<br />
                            Return Carrier: <?php echo $this->_tpl_vars['product']['product_return_tracking_carrier']; ?>
<br />
							Return Date shipped: <?php echo ((is_array($_tmp=$this->_tpl_vars['product']['product_return_shipping_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%D, %I:%M %p") : smarty_modifier_date_format($_tmp, "%D, %I:%M %p")); ?>
