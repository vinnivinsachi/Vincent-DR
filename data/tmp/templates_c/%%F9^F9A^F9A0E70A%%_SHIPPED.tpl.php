<?php /* Smarty version 2.6.19, created on 2010-10-04 18:09:38
         compiled from adminorders/_orderStatusControls/_SHIPPED.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'geturl', 'adminorders/_orderStatusControls/_SHIPPED.tpl', 4, false),)), $this); ?>
...
" >Message buyer: <?php echo $this->_tpl_vars['orderProfile']['buyer_name']; ?>
   		 ...
   		 <a class="anchorOrderMessageSeller" id="anchorID-anchorOrderMessageSeller-<?php echo $this->_tpl_vars['orderProfile']['order_unique_id']; ?>
_<?php echo $this->_tpl_vars['orderProfile']['order_profile_id']; ?>
" >Message seller: <?php echo $this->_tpl_vars['orderProfile']['uploader_username']; ?>
