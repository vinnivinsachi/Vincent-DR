<?php /* Smarty version 2.6.19, created on 2010-09-30 03:32:58
         compiled from ordermanager/_soldOrders/_message.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'geturl', 'ordermanager/_soldOrders/_message.tpl', 2, false),array('modifier', 'date_format', 'ordermanager/_soldOrders/_message.tpl', 4, false),)), $this); ?>
...
"/>
     <input type="hidden" name="receiver_User_id" value="<?php echo $this->_tpl_vars['product']['buyer_id']; ?>
"/>
     <input type="hidden" name="receiver_Username" value="<?php echo $this->_tpl_vars['product']['buyer_username']; ?>
"/>
     <input type="hidden" name='receiver_name' value="<?php echo $this->_tpl_vars['product']['buyer_name']; ?>
"/>
