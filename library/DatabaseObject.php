...
//----------------------------------for individual dues deletion---------------------
         ...
         * 
         */
        public static function BuildMultiple($db, $class, $data, $param=array())
        {
            $ret = array();
            ...
            if(isset($param['images'])){
            	$testObj = new $class($db, $param['image_table'], $param['product_tag']);
            }else{
            ...
            if (!$testObj instanceof DatabaseObject)
         	...
         	if(isset($param['images'])){
	         	foreach ($data as $row) {
	         		$obj = new $class($db, $param['image_table'], $param['product_tag']);
	                $obj->_init($row);
	                $ret[$obj->getId()] = $obj;
	            }            
         	}else{
